...
public class PoolJobExecutor implements BackgroundExecutor{
    ...
    private static final class ExecutorInstanceHolder{
        private static final PoolJobExecutor INSTANCE = new PoolJobExecutor();
    }

    public static PoolJobExecutor getInstance(){
